...
export const COLOUR_COMMANDS = [
  ...
  new Command("InputOverlayText", "rgb", "输入覆盖层文字色", "0,0,0"),
...
export const MANIA_COMMANDS = [
  ...
  new Command("ColourBarline", "rgba", "小节线颜色", "255,255,255,255", [], "官方 wiki 为 RGB(a) 类型，默认 255,255,255,255；A=0 时小节线完全透明"),
  ...
  new Command("ColourHold", "rgba", "按住长条时的连击数颜色", "255,191,51,255", [], "按住长条（LN）期间连击计数器的颜色（官方默认橙金色，stable 语义；lazer 已不支持）"),
  new Command("ColourBreak", "rgba", "断连时连击数颜色", "255,0,0,255", [], "miss 时连击计数器的颜色（官方默认红色，stable 语义）"),
  new Command("ColourKeyWarning", "rgb", "开局按键检查提示色", "0,0,0", [], "进入谱面前按键绑定检查（keybinding reminders）的提示颜色（官方默认黑色；stable 语义，lazer 已不支持）"),
...
export const MANIA_COLUMN_COMMANDS = [
  ...
  new Command("ColourLight{n1}", "rgb", "第{n1}列灯光颜色", "55,255,255", [], "列灯光（StageLight）颜色，官方 wiki 默认 55,255,255（青色）"),
